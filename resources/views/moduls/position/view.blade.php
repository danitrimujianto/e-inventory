      ...
      <form id="fProcess" class="fProcess2" method="post" enctype="multipart/form-data">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div>
              <input type="text" class="form-control" name="position" id="position" placeholder="" autocomplete="off" value="{{ $data->position }}" readonly>
            </div>
          </div>
          <div class="form-group">
            <label for="remarks">Remarks</label>
            <div>
              <input type="text" class="form-control" name="remarks" id="remarks" placeholder="" autocomplete="off" value="{{ $data->remarks }}" readonly>
            </div>
          </div>
        </div>
        <!-- /.box-body -->
