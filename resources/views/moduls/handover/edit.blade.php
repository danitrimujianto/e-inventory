  ...
  <div class="col-xs-12">
    ...
    <div class="box box-primary">
      ...
      <form id="fProcess" class="fProcess2" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" class="" name="fromcity_id" id="fromcity_id" value="{{ $data->fromcity_id }}" />
        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div>
                  <input type="text" class="form-control needed" name="karyawan_name" id="lookup_karyawan" value="{{ $data->sender->name }}" autocomplete="off"/>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div>
                  <input type="text" class="form-control needed" name="tocity_name" id="lookup_tocity" value="{{ optional($data->tocity)->name }}" autocomplete="off"/>
      						<span class="help-block2" style=" margin-top:0; margin-bottom: 0; clear:both;">Harus Diisi</span>
                </div>
              </div>
            </div>
          ...
          <div class="form-group">
            ...
            <div>
              <textarea class="form-control needed" name="remarks" id="remarks">{{ $data->remarks }}</textarea>
              <span class="help-block2" style=" margin-top:0; margin-bottom: 0; clear:both;">Harus Diisi</span>
            </div>
          </div>
