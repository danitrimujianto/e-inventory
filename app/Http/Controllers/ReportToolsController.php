...
use App\Core\Readers\ReportToolsReader;
...
use App\Core\Export\ReportToolsExcel;
use App\Core\Export\ReportToolsPrint;
...
class ReportToolsController extends ApplicationController
{
  /**
  ...
  public function index(Request $request)
  {
      ...
      try {
        $reader = new ReportToolsReader($request);
        $data = $reader->read();
