...
use App\Core\Handlers\AddDepartemenHandler;
use App\Core\Handlers\UpdateDepartemenHandler;
use App\Core\Handlers\DeleteDepartemenHandler;
use App\Core\Readers\DepartemenReader;
use App\Core\Readers\GetDepartemenReader;

use Session;
use HelpMe;
use DB;

class DepartemenController extends ApplicationController
{
  /**
  ...
  public function __construct()
  {
      ...
      $this->modul = "departemen"; //disetiap __construct controller harus ada
      $this->modulName = "Departemen"; //disetiap __construct controller harus ada
  ...
  public function store(Request $request)
  {
    $pos = "add";
    try {
      $handler = new AddDepartemenHandler($request);
      $data = $handler->handle();
  ...
  public function show($id)
  {
    ...
    try {
      $reader = new GetDepartemenReader($id);
      $data = $reader->read();
      $this->returnData['data'] = $data;
      return view('home', $this->returnData);
    } catch (\Exception $e) {
  ...
  public function update(Request $request, $id)
  {
    ...
    try {
      //dd($request);
      $handler = new UpdateDepartemenHandler($request);
      $data = $handler->handle();
      $this->createAlert("info", $pos." Succeeded");
  ...
  public function destroy($id)
  {
    $pos = "delete";
    try {
      $handler = new DeleteDepartemenHandler($id);
      $data = $handler->handle();
      $this->createAlert("info", $pos." Succeeded");
