...
use App\Core\Handlers\AddGoodsConditionHandler;
use App\Core\Handlers\UpdateGoodsConditionHandler;
use App\Core\Handlers\DeleteGoodsConditionHandler;
use App\Core\Readers\GoodsConditionReader;
use App\Core\Readers\GetGoodsConditionReader;

use Session;
use HelpMe;
use DB;

class GoodsConditionController extends ApplicationController
{
  /**
  ...
  public function __construct()
  {
      ...
      $this->modul = "goodscondition"; //disetiap __construct controller harus ada
      $this->modulName = "Condition"; //disetiap __construct controller harus ada
  ...
  public function store(Request $request)
  {
    $pos = "add";
    try {
      $handler = new AddGoodsConditionHandler($request);
      $data = $handler->handle();
  ...
  public function show($id)
  {
    ...
    try {
      $reader = new GetGoodsConditionReader($id);
      $data = $reader->read();
      $this->returnData['data'] = $data;
      return view('home', $this->returnData);
    } catch (\Exception $e) {
  ...
  public function update(Request $request, $id)
  {
    ...
    try {
      //dd($request);
      $handler = new UpdateGoodsConditionHandler($request);
      $data = $handler->handle();
      $this->createAlert("info", $pos." Succeeded");
  ...
  public function destroy($id)
  {
    $pos = "delete";
    try {
      $handler = new DeleteGoodsConditionHandler($id);
      $data = $handler->handle();
      $this->createAlert("info", $pos." Succeeded");
