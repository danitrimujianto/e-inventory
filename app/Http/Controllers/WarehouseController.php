...
use App\Core\Handlers\AddWarehouseHandler;
use App\Core\Handlers\UpdateWarehouseHandler;
use App\Core\Handlers\DeleteWarehouseHandler;
use App\Core\Readers\WarehouseReader;
use App\Core\Readers\GetWarehouseReader;
...
class WarehouseController extends ApplicationController
{
  /**
  ...
  public function __construct()
  {
      ...
      $this->modul = "warehouse"; //disetiap __construct controller harus ada
      $this->modulName = "Warehouse"; //disetiap __construct controller harus ada
  ...
  public function index(Request $request)
  {
      ...
      try {
        $reader = new WarehouseReader($request);
        $data = $reader->read();
  ...
  public function store(Request $request)
  {
    $pos = "add";
    try {
      $handler = new AddWarehouseHandler($request);
      $data = $handler->handle();
  ...
  public function show($id)
  {
    ...
    try {
      $reader = new GetWarehouseReader($id);
      $data = $reader->read();
      $this->returnData['data'] = $data;
      return view('home', $this->returnData);
    } catch (\Exception $e) {
  ...
  public function update(Request $request, $id)
  {
    ...
    try {
      //dd($request);
      $handler = new UpdateWarehouseHandler($request);
      $data = $handler->handle();
      $this->createAlert("info", $pos." Succeeded");
  ...
  public function destroy($id)
  {
    $pos = "delete";
    try {
      $handler = new DeleteWarehouseHandler($id);
      $data = $handler->handle();
      $this->createAlert("info", $pos." Succeeded");
