...
use App\Core\Handlers\AddDivisionHandler;
use App\Core\Handlers\UpdateDivisionHandler;
use App\Core\Handlers\DeleteDivisionHandler;
use App\Core\Readers\DivisionReader;
use App\Core\Readers\GetDivisionReader;

use Session;
use HelpMe;
use DB;

class DivisionController extends ApplicationController
{
  /**
  ...
  public function __construct()
  {
      ...
      $this->modul = "division"; //disetiap __construct controller harus ada
      $this->modulName = "Division"; //disetiap __construct controller harus ada
  ...
  public function store(Request $request)
  {
    $pos = "add";
    try {
      $handler = new AddDivisionHandler($request);
      $data = $handler->handle();
  ...
  public function show($id)
  {
    ...
    try {
      $reader = new GetDivisionReader($id);
      $data = $reader->read();
      $this->returnData['data'] = $data;
      return view('home', $this->returnData);
    } catch (\Exception $e) {
  ...
  public function update(Request $request, $id)
  {
    ...
    try {
      //dd($request);
      $handler = new UpdateDivisionHandler($request);
      $data = $handler->handle();
      $this->createAlert("info", $pos." Succeeded");
  ...
  public function destroy($id)
  {
    $pos = "delete";
    try {
      $handler = new DeleteDivisionHandler($id);
      $data = $handler->handle();
      $this->createAlert("info", $pos." Succeeded");
