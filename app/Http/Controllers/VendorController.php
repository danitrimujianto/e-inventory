...
use App\Core\Handlers\AddVendorHandler;
use App\Core\Handlers\UpdateVendorHandler;
use App\Core\Handlers\DeleteVendorHandler;
use App\Core\Readers\VendorReader;
use App\Core\Readers\GetVendorReader;

use Session;
use HelpMe;
use DB;

class VendorController extends ApplicationController
{
  /**
  ...
  public function __construct()
  {
      ...
      $this->modul = "vendor"; //disetiap __construct controller harus ada
      $this->modulName = "Vendor"; //disetiap __construct controller harus ada
