...
use App\Core\Handlers\AddSupplierHandler;
use App\Core\Handlers\UpdateSupplierHandler;
...
class SupplierController extends ApplicationController
{
  /**
  ...
  public function __construct()
  {
      ...
      $this->modul = "supplier"; //disetiap __construct controller harus ada
      $this->modulName = "Supplier"; //disetiap __construct controller harus ada
  ...
  public function store(Request $request)
  {
    $pos = "add";
    try {
      $handler = new AddSupplierHandler($request);
      $data = $handler->handle();
  ...
  public function show($id)
  {
    ...
    try {
      $reader = new GetSupplierReader($id);
      $data = $reader->read();
      $this->returnData['data'] = $data;
      return view('home', $this->returnData);
    } catch (\Exception $e) {
  ...
  public function update(Request $request, $id)
  {
    ...
    try {
      //dd($request);
      $handler = new UpdateSupplierHandler($request);
      $data = $handler->handle();
      $this->createAlert("info", $pos." Succeeded");
  ...
  public function destroy($id)
  {
    $pos = "delete";
    try {
      $handler = new DeleteSupplierHandler($id);
      $data = $handler->handle();
      $this->createAlert("info", $pos." Succeeded");
