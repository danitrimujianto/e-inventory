...
use App\Core\Export\ReportEmployeeToolsExcel;

use Session;
use HelpMe;
use DB;

class ReportEmployeeToolsController extends ApplicationController
{
  /**
  ...
  public function __construct()
  {
      ...
      $this->modul = "repemployeetools"; //disetiap __construct controller harus ada
      $this->modulName = "Report Employee Tools"; //disetiap __construct controller harus ada
  ...
  public function index(Request $request)
  {
    $pos = "index";
      ...
      try {
        ...
        $reader = new ReportEmployeeToolsReader($request);
        $data = $reader->read();
  ...
  public function excel(Request $request)
  {
    $pos = "Export Excel";
    try {
      return (new ReportEmployeeToolsExcel($request))->download('Report Employee Tools.xls');
    } catch (\Exception $e) {
      $msg = $this->resultException($e, $pos);
      return dd($msg);
    }
  ...
  public function print(Request $request)
  {
    ...
    try {
      ...
      $reader = new ReportEmployeeToolsReader($request, $isExport);
      $data = $reader->read();
